    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).pushNamed(
          AppRoute.characterDetailPage,
          arguments: charactersEntity.id.toString(),
        );
        ref
            .read(getCharacterProvider.notifier)
            .getCharacterDetail(charactersEntity.id.toString());
      },
      child: Stack(
        children: [
          Positioned.fill(
